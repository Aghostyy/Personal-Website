...
Öğrenciyim.
              ...
              <div className={`order-first lg:order-last flex-shrink-0 relative w-[160px] h-[160px] rounded-full pulse-avatar-online `}>
                <img alt="aghosty" src={`https://cdn.discordapp.com/attachments/986331334865739846/988460962384318484/AGHOSTY.png`} width="160" height="160" className={`bg-neutral-700 w-[160px] h-[160px] rounded-full`} />
            ...
            ? repositories
              ? repositories
                  ...
                  .map((_, __) => (
                    <a
                      key={__}
                      href={`https://github.com/aghostyy/`+_.name}
                      target="_blank"
                      rel="noreferrer"
