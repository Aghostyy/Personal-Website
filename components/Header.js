...
const items = [
    { icon: 'fab fa-youtube', link: 'https://youtube.com/UCx0p2lhofftebQSoPtar0hw' },
    { icon: 'fab fa-discord', link: 'https://discord.com/users/875334919361011793' },
    { icon: 'fab fa-instagram', link: 'https://instagram.com/serhatamav2' },
    { icon: 'fab fa-github', link: 'https://github.com/aghostyy' },
    { icon: 'fab fa-twitter', link: 'https://twitter.com/aghossty' },
  ]
